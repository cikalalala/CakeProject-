                ...
                <div class="row">
                                ...
                                <div class="swiper-container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                                class="h-auto" src="{{ asset('storage/uploads') }}/{{ $product->image }}" width="104"
                                                height="104" alt="" /></div>
                                        <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                                class="h-auto" src="/assets/images/products/product_0-1.jpg"
                                                width="104" height="104" alt="" /></div>
                                        <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                                class="h-auto" src="/assets/images/products/product_0-2.jpg"
                                                width="104" height="104" alt="" /></div>
                                        <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                                class="h-auto" src="/assets/images/products/product_0-3.jpg"
                                                width="104" height="104" alt="" /></div>
                                    </div>
                                </div>
                            </div> --}}
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="product-single__price">
                            <span class="current-price">Rp <?= $product->sale_price ?></span>
                        </div>
                        <div class="product-single__short-desc">
                            <p> <?= $product->short_description ?></p>
                        </div>
                        <form name="addtocart-form" method="get" id="checkout-form">
                            <div class="product-single__addtocart">
                                <div class="qty-control position-relative">
                                    <input type="number" name="qty" value="1" min="1"
                                        class="qty-control__number text-center" id="quantity-input">
                                    <div class="qty-control__reduce" id="reduce-btn">-</div>
                                    <div class="qty-control__increase" id="increase-btn">+</div>
                                </div><!-- .qty-control -->
                                <input type="hidden" name="product" value="<?= $product->slug ?>" id="product-input">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-description" role="tabpanel"
                            ...
                            <div class="product-single__description">
                                <h3 class="block-title mb-4">Description Product</h3>
            ...
            {{-- <section class="products-carousel container">
                ...
                <script>
                    function redirectToCheckout() {
                        ...
                        const qty = qtyInput.value || 1; // Ambil nilai qty, default 1
                        const productSlug = productInput.value; // Ambil nilai product slug

                        // Atur URL tujuan
                        const checkoutUrl = `/checkout/${productSlug}/${qty}`;
                    ...
                    // Fungsi untuk menyesuaikan kuantitas
                    function adjustQuantity(change) {
                        let currentQty = parseInt(qtyInput.value) || 1;
                        currentQty = Math.max(1, currentQty + change); // Pastikan nilai minimal adalah 1
                        qtyInput.value = currentQty;
                    }

                    // Tambahkan event listener ke tombol
                    reduceBtn.addEventListener('click', () => adjustQuantity(-1 + 1));
                    increaseBtn.addEventListener('click', () => adjustQuantity(1 - 1));
                </script>
